    ...
    <div class="container-fluid">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ route('subcategories.update', $subcategory) }}">
                    <div>
                        ...
                        <div class="input-group flex-nowrap mb-3">
                            ...
                            <select name="category_id" id="category_id" class="form-select">
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" @if($category->id == $subcategory->category_id) selected @endif >{{ mb_strtoupper($category->name_ru) }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="input-group flex-nowrap mb-3">
                            ...
                            <input type="text" name="name_ru" id="name_ru" value="{{ $subcategory->name_ru }}" class="form-control" placeholder="REQUIRED" aria-describedby="addon-wrapping" required>
                        </div>
                        ...
                        <div class="input-group flex-nowrap mb-3">
                            ...
                            <input type="text" name="name_ua" id="name_ua" value="{{ $subcategory->name_ua }}" class="form-control" placeholder="REQUIRED" aria-describedby="addon-wrapping" required>
                        </div>
                        ...
                        <div class="input-group flex-nowrap mb-3">
                            ...
                            <input type="text" name="slug" id="slug" value="{{ $subcategory->slug }}" class="form-control" placeholder="REQUIRED" aria-describedby="addon-wrapping" required>
                        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="col-12">
                ...
                <h4>ТОВАРЫ - {{ $subcategory->name_ru }}</h4>
